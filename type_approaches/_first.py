...
from typing import TYPE_CHECKING, Any, Concatenate, Final, Never

from pyochain._core import Pipeable
from pyochain._result import Result
...
type Option[T] = Some[T] | NoneOption[Any]
