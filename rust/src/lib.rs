...
fn rs(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<iterators::UniqueIdentity>()?;
    m.add_class::<iterators::UniqueKey>()?;
    m.add_class::<iterators::Intersperse>()?;
    m.add_class::<iterators::MapWindow>()?;
    m.add_class::<iterators::MapJuxt>()?;
    m.add_class::<iterators::FilterMap>()?;
    m.add_class::<iterators::FilterMapStar>()?;
    m.add_class::<iterators::Scan>()?;
    m.add_class::<iterators::MapWhile>()?;
    m.add_class::<iterators::FromFn>()?;
    m.add_class::<iterators::Drain>()?;
    m.add_class::<iterators::ExtractIf>()?;
    m.add_class::<iterators::Successors>()?;
    m.add_class::<iterators::FilterStar>()?;
    m.add_class::<iterators::WithPosition>()?;
    m.add_class::<iterators::ZipLongest>()?;
    m.add_class::<iterators::Unzip>()?;
    m.add_class::<iterators::GroupBy>()?;
