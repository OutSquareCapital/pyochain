...
#[pyclass(module = "pyochain._collections",frozen, generic, sequence, extends = abc::PyoMutableSequence, subclass)]
pub struct Heap;
#[pyclass(module = "pyochain._collections",frozen, generic, sequence, extends = Heap)]
